...
from ..eval.POS_eval import pos_eval_sentence, pos_evaluate_word_PRF, pos_evaluate_OOV, pos_pred_result
...
class DPOS(nn.Module):
    ...
    def fit(cls, args):
        ...
        best = {'dev': {'best_epoch': 0, 'best_pp': -1, 'best_pr': -1, 'best_pf': -1, 'best_poov': -1},
                'test': {'best_epoch': 0, 'best_pp': -1, 'best_pr': -1, 'best_pf': -1, 'best_poov': -1},
                }
