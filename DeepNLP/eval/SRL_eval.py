...
# def replace_predicates(label_list):
#     new_label_list = []
...
#
#
# def evaluate(all_y, all_y_pred):
#     new_all_y_pred = replace_predicates(all_y_pred)
#     new_all_y = replace_predicates(all_y)
#
#     p = precision_score(new_all_y, new_all_y_pred)
#     r = recall_score(new_all_y, new_all_y_pred)
#     f = f1_score(new_all_y, new_all_y_pred)
#
